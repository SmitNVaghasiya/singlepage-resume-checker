    ...
    <div className="analysis-card">
      <div className="analysis-scores">
        <div className="analysis-score-card blue">
          <div className="analysis-score-value blue">{analysis.score}</div>
        ...
        <div className="analysis-score-card green">
          <div className="analysis-score-value green">{analysis.matchPercentage}%</div>
      ...
      <div className="analysis-remarks">
        <h3 className="analysis-remarks-title">AI Remarks</h3>
        <p className="analysis-remarks-text">{analysis.remarks}</p>
      </div>
