...
import { Star, TrendingUp, CheckCircle, AlertCircle, Target, Award } from 'lucide-react';
...
const AnalysisCard: React.FC<AnalysisCardProps> = ({ analysis, showFullDetails = false }) => {
  ...
  const getScore = () => {
    return analysis.score_out_of_100 || analysis.overallScore || (analysis as any).score || 0;
  };

  const getMatchPercentage = () => {
    return analysis.chance_of_selection_percentage || analysis.matchPercentage || 0;
  };

  const getOverallRecommendation = () => {
    return analysis.short_conclusion || analysis.overallRecommendation || (analysis as any).remarks || 'Analysis completed successfully.';
  };
  ...
  const getImprovements = () => {
    ...
    if (analysis.resume_analysis_report?.weaknesses_analysis) {
      return [
        ...analysis.resume_analysis_report.weaknesses_analysis.critical_gaps_against_job_description.slice(0, 3),
        ...analysis.resume_analysis_report.weaknesses_analysis.resume_presentation_issues.slice(0, 2)
      ];
    }
    return analysis.developmentAreas || (analysis as any).improvements || (analysis as any).suggestions || [];
  };
    ...
    <div className="analysis-card">
      <div className="analysis-scores">
        ...
        <div className="analysis-score-card green">
          <div className="analysis-score-value green">{getMatchPercentage()}%</div>
      ...
      <div className="analysis-status">
        ...
        <div className="status-item">
          ...
          <span className="status-text">Job Description: {getValidityStatus()}</span>
        </div>
      </div>
        ...
        <div className="analysis-details">
          <div className="analysis-section">
            ...
            <div className="analysis-items">
              {getStrengths().slice(0, 5).map((strength, index) => (
          ...
          <div className="analysis-section">
            ...
            <div className="analysis-items">
              {getImprovements().slice(0, 5).map((improvement, index) => (
            ...
            <div className="analysis-section">
              ...
              <div className="candidate-info">
                <div className="info-item">
                  <strong>Name:</strong> {analysis.resume_analysis_report.candidate_information.name}
                </div>
                <div className="info-item">
                  <strong>Position Applied:</strong> {analysis.resume_analysis_report.candidate_information.position_applied}
                </div>
                <div className="info-item">
                  <strong>Experience Level:</strong> {analysis.resume_analysis_report.candidate_information.experience_level}
                </div>
                <div className="info-item">
                  <strong>Current Status:</strong> {analysis.resume_analysis_report.candidate_information.current_status}
                </div>
              </div>
            </div>
          )}
