  ...
  return (
    <div className="job-description-section">
        ...
        {jobInputMethod === "text" ? (
          <div className="job-text-input">
            <div className="job-textarea-container">
              ...
              />
              <div
                className={`job-word-counter ${
                  isTextValid ? "valid" : "invalid"
                }`}
              >
                <div className="word-info">
                  <span className="word-count">
                    {wordCount} characters (minimum 50 required)
                  </span>
                  {isTextValid ? (
                    ...
                    <div className="validation-status invalid">
                      ...
                      <span>
                        Need at least {minWords - wordCount} more characters
                      </span>
                    </div>
                  )}
                </div>
            ...
            <div className="job-file-upload-area">
              ...
              {jobFile ? (
                  ...
                  <div className="job-file-info">
                    ...
                    <div className="job-file-details">
                      ...
                      <p className="job-file-size">
                        ...
                        {jobFile.type.split("/")[1].toUpperCase()}
                      </p>
                    </div>
                  </div>
                  <button
                ...
                <label
                  ...
                  className="job-file-upload-label"
                >
      ...
      <div className="job-section-actions">
        <button onClick={onBack} className="job-back-btn">
