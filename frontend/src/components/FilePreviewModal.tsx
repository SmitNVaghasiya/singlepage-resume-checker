...
import { X, Download, Eye, FileText, File, Image, Archive, Music, Video, Code } from 'lucide-react';
import * as mammoth from 'mammoth';
import "../styles/components/FilePreviewModal.css";
...
const FilePreviewModal: React.FC<FilePreviewModalProps> = ({
  ...
  const [previewType, setPreviewType] = useState<'pdf' | 'text' | 'html' | 'image' | 'unsupported'>('unsupported');
    ...
    try {
      ...
      if (fileType === 'application/pdf') {
        ...
        try {
          ...
          setError('Failed to convert DOCX file. The file may be corrupted or use unsupported features.');
        }
        ...
        setError(`${fileType || 'Unknown file type'} files cannot be previewed directly. Please download the file to view its contents.`);
  ...
  const getFileIcon = () => {
    ...
    } else if (fileName.endsWith('.js') || fileName.endsWith('.ts') || fileName.endsWith('.tsx') || fileName.endsWith('.jsx') || fileName.endsWith('.css') || fileName.endsWith('.html') || fileName.endsWith('.json') || fileName.endsWith('.xml') || fileName.endsWith('.py') || fileName.endsWith('.java') || fileName.endsWith('.cpp') || fileName.endsWith('.c') || fileName.endsWith('.php') || fileName.endsWith('.rb') || fileName.endsWith('.go') || fileName.endsWith('.rs') || fileName.endsWith('.sql')) {
