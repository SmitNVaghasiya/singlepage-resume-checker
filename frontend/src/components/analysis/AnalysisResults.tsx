    ...
    <div className="analysis-results-container">
      ...
      <div className="summary-cards">
        <div
          ...
          style={
            { "--card-color": getScoreColor(getScore()) } as React.CSSProperties
          }
        >
        ...
        <div
          ...
          style={
            {
              "--card-color": getChanceColor(getChance()),
            } as React.CSSProperties
          }
        >
          <div className="card-icon">
        ...
        <div className="summary-card validity-card">
          ...
          <div className="card-value">
            {analysisResult.job_description_validity || "Valid"}
          </div>
        ...
        <div className="summary-card status-card">
          ...
          <h3>Resume Status</h3>
          <div className="card-value">
            {analysisResult.resume_eligibility || "Eligible"}
          </div>
          <div className="card-unit">status</div>
        </div>
      </div>
          ...
          <TabContent tabId="overview">
            ...
            <div className="overview-grid">
              ...
              <div className="overview-card">
                ...
                <h4>Job Matching</h4>
                <p>
                  Comprehensive matching of skills, experience, and
                  qualifications
                </p>
              </div>
              <div className="overview-card">
                ...
                <p>
                  Actionable insights for resume improvement and career growth
                </p>
              </div>
              <div className="overview-card">
                <div className="overview-icon">
                ...
                <div className="stat-item">
                  <div className="stat-number">
                    {analysisResult.resume_analysis_report
                      ?.improvement_recommendations?.immediate_resume_additions
                      ?.length || 0}
                  </div>
                ...
                <>
                  ...
                  >
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.strengths_analysis.technical_skills.map(
                        (skill, index) => (
                          <li key={index}>
                  ...
                  >
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.strengths_analysis.project_portfolio.map(
                        (project, index) => (
                          <li key={index}>
                            <CheckCircle2 className="strength-icon" />
                            {project}
                  ...
                  >
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.strengths_analysis.educational_background.map(
                        (edu, index) => (
                          <li key={index}>
                            <CheckCircle2 className="strength-icon" />
                            {edu}
            ...
            <div className="weaknesses-grid">
              {analysisResult.resume_analysis_report?.weaknesses_analysis && (
                <>
                  ...
                  >
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.weaknesses_analysis.critical_gaps_against_job_description.map(
                        (gap, index) => (
                          <li key={index}>
                  ...
                  >
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.weaknesses_analysis.technical_deficiencies.map(
                        (deficiency, index) => (
                          <li key={index}>
                            <XCircle className="weakness-icon" />
                            {deficiency}
                  ...
                  >
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.weaknesses_analysis.resume_presentation_issues.map(
                        (issue, index) => (
                          <li key={index}>
                            <XCircle className="weakness-icon" />
                            {issue}
                  ...
                  >
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.weaknesses_analysis.soft_skills_gaps.map(
                        (gap, index) => (
                          <li key={index}>
                            <XCircle className="weakness-icon" />
                            {gap}
                  ...
                  >
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.weaknesses_analysis.missing_essential_elements.map(
                        (element, index) => (
                          <li key={index}>
                            <XCircle className="weakness-icon" />
                            {element}
                ...
                <>
                  <div className="feedback-section">
                    ...
                    <div className="feedback-state">
                      {
                        analysisResult.resume_analysis_report
                          .section_wise_detailed_feedback.contact_information
                          .current_state
                      }
                    </div>
                    <div className="feedback-content">
                      <div className="feedback-list">
                        <h5>Strengths:</h5>
                        <ul className="item-list">
                          {analysisResult.resume_analysis_report.section_wise_detailed_feedback.contact_information.strengths.map(
                            (strength, index) => (
                              <li key={index}>
                                <CheckCircle2 className="strength-icon" />
                                {strength}
                      ...
                      <div className="feedback-list improvements">
                        <h5>Improvements:</h5>
                        <ul className="item-list">
                          {analysisResult.resume_analysis_report.section_wise_detailed_feedback.contact_information.improvements.map(
                            (improvement, index) => (
                              <li key={index}>
                  ...
                  <div className="feedback-section">
                    ...
                    <div className="feedback-state">
                      {
                        analysisResult.resume_analysis_report
                          .section_wise_detailed_feedback.profile_summary
                          .current_state
                      }
                    </div>
                    <div className="feedback-content">
                      <div className="feedback-list">
                        <h5>Strengths:</h5>
                        <ul className="item-list">
                          {analysisResult.resume_analysis_report.section_wise_detailed_feedback.profile_summary.strengths.map(
                            (strength, index) => (
                              <li key={index}>
                                <CheckCircle2 className="strength-icon" />
                                {strength}
                      ...
                      <div className="feedback-list improvements">
                        <h5>Improvements:</h5>
                        <ul className="item-list">
                          {analysisResult.resume_analysis_report.section_wise_detailed_feedback.profile_summary.improvements.map(
                            (improvement, index) => (
                              <li key={index}>
                                <AlertTriangle className="improvement-icon" />
                                {improvement}
                  ...
                  <div className="feedback-section">
                    ...
                    <div className="feedback-state">
                      {
                        analysisResult.resume_analysis_report
                          .section_wise_detailed_feedback.education
                          .current_state
                      }
                    </div>
                    <div className="feedback-content">
                      <div className="feedback-list">
                        <h5>Strengths:</h5>
                        <ul className="item-list">
                          {analysisResult.resume_analysis_report.section_wise_detailed_feedback.education.strengths.map(
                            (strength, index) => (
                              <li key={index}>
                                <CheckCircle2 className="strength-icon" />
                                {strength}
                      ...
                      <div className="feedback-list improvements">
                        <h5>Improvements:</h5>
                        <ul className="item-list">
                          {analysisResult.resume_analysis_report.section_wise_detailed_feedback.education.improvements.map(
                            (improvement, index) => (
                              <li key={index}>
                                <AlertTriangle className="improvement-icon" />
                                {improvement}
                  ...
                  <div className="feedback-section">
                    ...
                    <div className="feedback-state">
                      {
                        analysisResult.resume_analysis_report
                          .section_wise_detailed_feedback.skills.current_state
                      }
                    </div>
                    <div className="feedback-content">
                      <div className="feedback-list">
                        <h5>Strengths:</h5>
                        <ul className="item-list">
                          {analysisResult.resume_analysis_report.section_wise_detailed_feedback.skills.strengths.map(
                            (strength, index) => (
                              <li key={index}>
                                <CheckCircle2 className="strength-icon" />
                                {strength}
                      ...
                      <div className="feedback-list improvements">
                        <h5>Improvements:</h5>
                        <ul className="item-list">
                          {analysisResult.resume_analysis_report.section_wise_detailed_feedback.skills.improvements.map(
                            (improvement, index) => (
                              <li key={index}>
                                <AlertTriangle className="improvement-icon" />
                                {improvement}
                  ...
                  <div className="feedback-section">
                    ...
                    <div className="feedback-state">
                      {
                        analysisResult.resume_analysis_report
                          .section_wise_detailed_feedback.projects.current_state
                      }
                    </div>
                    <div className="feedback-content">
                      <div className="feedback-list">
                        <h5>Strengths:</h5>
                        <ul className="item-list">
                          {analysisResult.resume_analysis_report.section_wise_detailed_feedback.projects.strengths.map(
                            (strength, index) => (
                              <li key={index}>
                                <CheckCircle2 className="strength-icon" />
                                {strength}
                      ...
                      <div className="feedback-list improvements">
                        <h5>Improvements:</h5>
                        <ul className="item-list">
                          {analysisResult.resume_analysis_report.section_wise_detailed_feedback.projects.improvements.map(
                            (improvement, index) => (
                              <li key={index}>
                                <AlertTriangle className="improvement-icon" />
                                {improvement}
              ...
              {analysisResult.resume_analysis_report
                ...
                <>
                  <div className="recommendation-category">
                    ...
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.improvement_recommendations.immediate_resume_additions.map(
                        (addition, index) => (
                          <li key={index}>
                  ...
                  <div className="recommendation-category">
                    ...
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.improvement_recommendations.immediate_priority_actions.map(
                        (action, index) => (
                          <li key={index}>
                            <ArrowRight className="recommendation-icon" />
                            {action}
                  ...
                  <div className="recommendation-category">
                    ...
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.improvement_recommendations.short_term_development_goals.map(
                        (goal, index) => (
                          <li key={index}>
                            <ArrowRight className="recommendation-icon" />
                            {goal}
                  ...
                  <div className="recommendation-category">
                    ...
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.improvement_recommendations.medium_term_objectives.map(
                        (objective, index) => (
                          <li key={index}>
                            <ArrowRight className="recommendation-icon" />
                            {objective}
              ...
              <div className="skills-enhancement">
                ...
                <div className="skills-grid">
                  <div className="skill-category">
                    ...
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.soft_skills_enhancement_suggestions.communication_skills.map(
                        (skill, index) => (
                          <li key={index}>
                  ...
                  <div className="skill-category">
                    ...
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.soft_skills_enhancement_suggestions.teamwork_and_collaboration.map(
                        (skill, index) => (
                          <li key={index}>
                  ...
                  <div className="skill-category">
                    ...
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.soft_skills_enhancement_suggestions.leadership_and_initiative.map(
                        (skill, index) => (
                          <li key={index}>
                  ...
                  <div className="skill-category">
                    ...
                    <ul className="item-list">
                      {analysisResult.resume_analysis_report.soft_skills_enhancement_suggestions.problem_solving_approach.map(
                        (skill, index) => (
                          <li key={index}>
                ...
                {analysisResult.resume_analysis_report?.final_assessment && (
                  <>
                    ...
                    <div className="assessment-item">
                      ...
                      <ul className="item-list">
                        {analysisResult.resume_analysis_report.final_assessment.key_interview_areas.map(
                          (area, index) => (
                            <li key={index}>
                    ...
                    <div className="assessment-item">
                      ...
                      <ul className="item-list">
                        {analysisResult.resume_analysis_report.final_assessment.onboarding_requirements.map(
                          (requirement, index) => (
                            <li key={index}>
