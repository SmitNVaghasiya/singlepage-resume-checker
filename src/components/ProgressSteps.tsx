    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center justify-center space-x-8 mb-12">
        {steps.map((step, index) => {
          ...
          const isCompleted = index < currentStep || (index === 2 && analysisResult);
            ...
            <div key={index} className="flex items-center">
                ...
                <button
                  ...
                  className={`
                    ...
                    ${isActive ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg' : 
                      ...
                      canAccess ? 'bg-gray-200 text-gray-500 hover:bg-gray-300' : 'bg-gray-100 text-gray-400'}
              ...
              {index < steps.length - 1 && (
                <div className={`
                  ...
                  ${index < currentStep || (index === 1 && analysisResult) ? 'bg-green-500' : 'bg-gray-200'}
                `} />
              )}
            </div>
          );
